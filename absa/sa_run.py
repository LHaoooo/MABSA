...
def run_train_epoch(args,  global_step, model, param_optimizer,
                    ...
                    save_checkpoints_steps, best_f1): # optimizer_rel,scheduler_rel,train_phase1_loader, -2start_save_steps,
    print("run_train_epoch")
...
def main():
    ...
    parser.add_argument("--vocab_file", default='../data/bert/bert-base-uncased/vocab.txt', 
                        type=str, required=False,help="The vocabulary file that the BERT model was trained on.")
    parser.add_argument("--output_dir", default='../out/output', type=str, required=False,
                        help="The output directory where the model checkpoints will be written.")
    parser.add_argument("--train_file", default=None, type=str, help="txt for training")
    parser.add_argument("--predict_file", default=None, type=str, help="txt for prediction")
    parser.add_argument("--data_dir", default='../data/Twitter/twitter15_pre', 
                        type=str, help="text data dir")
    parser.add_argument("--init_checkpoint", 
                        default='../data/bert/bert-base-uncased/pytorch_model.bin', type=str,
                        help="Initial checkpoint (usually from a pre-trained BERT model).")  # None
    parser.add_argument("--image_path", default="../data/Twitter/twitter2015_images/")
    parser.add_argument("--pre_split_file", default="../data/")#data/
    parser.add_argument("--pre_image_obj_features_dir", default="../data/Twitter_images")
    parser.add_argument("--cache_dir", default="../data/image_cache_dir/")#"data/image_cache_dir/"
    
    ## Other parameters
    parser.add_argument("--debug", default=False, action='store_true', help="Whether to run in debug mode.")#debug
    ...
    parser.add_argument("--logit_threshold", default=8., type=float,help="Logit threshold for annotating labels.")
    parser.add_argument("--filter_type", default="f1", type=str, help="Which filter type to use")
    parser.add_argument("--use_heuristics", default=True, action='store_true',help="If true, use heuristic regularization on span length")
    parser.add_argument("--use_nms", default=True, action='store_true',help="If true, use nms to prune redundant spans")
